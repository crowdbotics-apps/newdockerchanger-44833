"""
Django settings for newdockerchanger_44833 project.
...
ROOT_URLCONF = 'newdockerchanger_44833.urls'
...
WSGI_APPLICATION = 'newdockerchanger_44833.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newdockerchanger_44833 API",
    "DESCRIPTION": "API documentation for newdockerchanger_44833 App",
    "VERSION": "v1",
}
